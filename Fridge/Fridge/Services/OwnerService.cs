...
namespace Fridge.Services
{
    public class OwnerService : IOwnerService
    {
        ...
        public async Task<RentDocumentDto> GetRentedFridgeInfo(Guid fridgeId)
        {
            ...
            var rentedFridgeData = _repository.RenterFridge.GetFridgeById(fridgeId, trackChanges: false);
            ...
            {
                Id = rentDocument.Id,
                RenterEmail = _repository.Renter.FindRenterByCondition(u => u.Id == rentDocument.RenterId, trackChanges: false).Email,
